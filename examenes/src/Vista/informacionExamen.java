...
public class informacionExamen extends javax.swing.JFrame {
 CtrlTema ctrlTema=new CtrlTema();
 
    /**
     * Creates new form informacionExamen
     */
    ...
    private void btn_GuardarOpcionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_GuardarOpcionActionPerformed
        ...
        if (cb_jornada.equals("Mañana")) {
            ctrlTema.setJornada("Mañana");
            jornada="Mañana";
        } else if (cb_jornada.equals("Tarde")){
            ctrlTema.setJornada("Tarde");
            jornada="Tarde";
        }

        if (cb_semestre.equals("1")) {
            ctrlTema.setSemestre(1);
            semestre=1;
        } else if (cb_semestre.equals("2")) {
            ctrlTema.setSemestre(2);
            semestre=2;
        }

        int year = Integer.parseInt(txt_year.getText());
        ctrlTema.setYear(year);
     try {
